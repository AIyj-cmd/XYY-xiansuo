...
module.exports = {
  apps: [{
    ...
    env: {
      ...
      OPENCLAW_GATEWAY_URL: configured('OPENCLAW_GATEWAY_URL', 'http://127.0.0.1:38115'), OPENCLAW_GATEWAY_SEND_TIMEOUT_MS: configured('OPENCLAW_GATEWAY_SEND_TIMEOUT_MS', '30000'), OPENCLAW_GATEWAY_TIMEOUT_MS: configured('OPENCLAW_GATEWAY_TIMEOUT_MS', '40000'), OPENCLAW_MAX_ATTEMPTS: configured('OPENCLAW_MAX_ATTEMPTS', '2'),
